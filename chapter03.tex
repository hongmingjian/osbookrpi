...
\label{code:3-15}
\inputminted[firstline=83,lastline=116,linenos,numbersep=5pt,frame=lines,framesep=2mm]{c}{src/chapter03/kernel/machdep.c}
\end{code}
...
\captionof{listing}{chapter03/kernel/machdep.c}
\label{code:3-18}
\inputminted[firstline=118,lastline=132,linenos,numbersep=5pt,frame=lines,framesep=2mm]{c}{src/chapter03/kernel/machdep.c}
\end{code}
...
\label{code:3-19}
\inputminted[firstline=4,lastline=23,linenos,numbersep=5pt,frame=lines,framesep=2mm]{c}{src/chapter03/kernel/kernel.c}
\end{code}
...
\captionof{listing}{chapter03/kernel/machdep.c}
\label{code:3-20}
\inputminted[firstline=134,lastline=166,linenos,numbersep=5pt,frame=lines,framesep=2mm]{c}{src/chapter03/kernel/machdep.c}
\end{code}
